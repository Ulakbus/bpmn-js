...
var UpdatePropertiesHandler = require('./cmd/UpdatePropertiesHandler'),
    ...
    UpdateLaneRefsHandler = require('./cmd/UpdateLaneRefsHandler');
...
Modeling.prototype.getHandlers = function() {
  ...
  handlers['element.updateLaneRefs'] = UpdateLaneRefsHandler;
...
/**
 * Update the lane references of all contained flow nodes.
 *
 * @param  {djs.model.Shape} rootShape
 */
Modeling.prototype.updateLaneRefs = function(rootShape) {
  this._commandStack.execute('element.updateLaneRefs', {
    rootShape: rootShape
  });
};
